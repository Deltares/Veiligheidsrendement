...
Section1.Reliability.Overflow = MechanismReliabilityCollection('Overflow','Prob',np.arange(1,52,10))
...
Section1.Reliability.Piping = MechanismReliabilityCollection('Piping','Prob',np.arange(1,52,10))
