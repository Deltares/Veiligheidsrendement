...
class MeasureImporter(OrmImporterProtocol):
    ...
    def _get_standard_measure(self, measure_type: Type[MeasureBase], orm_measure: StandardMeasure) -> MeasureBase:
        ...
        _measure.parameters["Pf_solution"] = orm_measure.failure_probability_with_solution
