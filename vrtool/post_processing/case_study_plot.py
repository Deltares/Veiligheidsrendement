...
def main():
    ...
    AllStrategies[1].makeSolution(
        config.directory.joinpath("results", "FinalMeasures_Doorsnede-eisen.csv"),
        type="Final",
    )
    AllStrategies[0].makeSolution(
        config.directory.joinpath("results", "FinalMeasures_Veiligheidsrendement.csv"),
