...
class MechanismPerYearProbabilityCollection:
    ...
    def combine(
        ...
        for m in _mechanism1:
            ...
            self._combine_years(m, second, _nw_probabilities)
