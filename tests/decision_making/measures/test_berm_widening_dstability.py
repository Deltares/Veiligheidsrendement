...
class TestBermWideningDStability:
    ...
    def test_find_polygons_to_fill_to_measure_multiple_polygons_returned(self):
        ...
        _list_polygons = [Polygon([[0, 0], [2, 0], [2, 1], [0, 1]])]
        _berm_widening_dstability.measure_geometry_points = [[0, 2], [0.5, 1], [1.5, 1], [2, 2]]
    ...
    def test_get_bounding_box(self):
        ...
        # Call
        bbox = _berm_widening_dstability.get_bounding_box(_top_surface, _cropped_polygon_below_surface)
