...
valid_dike_section_cases = [
    dict(
        crest_height=9.98,
        section_length=397,
        piping_properties=piping_properties_cases[0],
    ),
    dict(
        crest_height=9.93,
        section_length=286,
        piping_properties=piping_properties_cases[1],
    ),
    dict(
        crest_height=9,
        section_length=397,
        piping_properties=piping_properties_cases[2],
    ),
]
