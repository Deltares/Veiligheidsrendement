...
class TestSgShMeasure:
    ...
    def test_create_sg_sh_measure(self):
        ...
        # 2. Run test
        _measure = self._create_sg_sh_measure(_measure_type, _combine_type)

        # 3. Verify expectations
        assert isinstance(_measure, SgShMeasure)
