...
-- VRTOOL-542 Migration of tables to remove the columns 
-- `prob_of_solution_failure`, `failure_probability_with_solution`, `stability_screen_s_f_increase`
-- from the `StandardMeasure` table.
