...
TestCase.ReadAllTrajectInput(pad, 'Case_' + casename, years0, startyear=2025)
...
AllStrategies, Solutions = runFullModel(TestCase, casename, pad, years=years0, timing=timing, save_beta_measure_plots=save_beta_measure_plots,language='NL',types=['TC','OI'],OI_year = 0) #,TestCaseSolutions=TestCaseSolutions)
...
#MAKING PLOTS:
MeasureTable = getMeasureTable(Solutions)
